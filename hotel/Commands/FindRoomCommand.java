...
public class FindRoomCommand implements Command {
    ...
    public FindRoomCommand(Controller controller) {
    ...
    public String getHelp() {
        return "find <beds> <from> <to> - Finds available rooms with specific beds for given dates.";
    }
    ...
    public void execute(String[] args) {
        ...
        try {
            ...
            controller.findRoomsWithBeds(fromDate, toDate, beds);
